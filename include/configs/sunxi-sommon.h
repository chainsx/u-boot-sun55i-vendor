...
#define FDT_ADDR_R        __stringify(SDRAM_OFFSET(3600000))
#define SCRIPT_ADDR_R     __stringify(SDRAM_OFFSET(3700000))
#define PXEFILE_ADDR_R    __stringify(SDRAM_OFFSET(3800000))
#define FDTOVERLAY_ADDR_R __stringify(SDRAM_OFFSET(3900000))
#define RAMDISK_ADDR_R    __stringify(SDRAM_OFFSET(3A00000))
