 ...
 */
#define BOOTM_SIZE        __stringify(0xa000000)
#define KERNEL_ADDR_R     __stringify(SDRAM_OFFSET(0080000))  /* 0x40080000 */
#define FDT_ADDR_R        __stringify(SDRAM_OFFSET(3600000))  /* 0x43600000 */
#define SCRIPT_ADDR_R     __stringify(SDRAM_OFFSET(3700000))  /* 0x43700000 */
#define PXEFILE_ADDR_R    __stringify(SDRAM_OFFSET(3800000))  /* 0x43800000 */
#define FDTOVERLAY_ADDR_R __stringify(SDRAM_OFFSET(3900000))  /* 0x43900000 */
#define RAMDISK_ADDR_R    __stringify(SDRAM_OFFSET(3A00000))  /* 0x43a00000 */
